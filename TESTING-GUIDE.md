...
✅ **Both windows**: Should show empty items list initially

### **Step 4: Add Items & Test Voting**
1. **Admin**: Click "Add new item" and enter a task (e.g., "Login page")
2. **Admin**: Select the item for voting
3. **Participant**: Click a card to vote
4. **Admin**: See participant's card turn green with "?"
5. **Admin**: Click "Reveal Votes"
6. **Both windows**: Should see actual vote value and statistics
